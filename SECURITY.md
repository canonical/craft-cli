...
- The most recent patch version of Craft CLI.
- Any version of Craft CLI that's included in a current release of a Canonical
  product.
...
[Private Security Report]: https://github.com/canonical/craft-cli/security/advisories/new
