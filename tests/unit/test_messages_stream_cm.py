...
def test_streamcm_init_silent(recording_printer):
    ...
    scm = _StreamContextManager(recording_printer, "initial text", stream=None, use_timestamp=False)
...
def test_streamcm_init_with_stream(recording_printer, stream):
    ...
    scm = _StreamContextManager(recording_printer, "initial text", stream=stream, use_timestamp=False)
...
def test_streamcm_init_with_stream_and_timestamp(recording_printer, stream):
    ...
    scm = _StreamContextManager(recording_printer, "initial text", stream=stream, use_timestamp=True)
...
def test_streamcm_dont_consume_exceptions(recording_printer):
    ...
    with pytest.raises(ValueError):
        with _StreamContextManager(recording_printer, "initial text", stream=None, use_timestamp=False):
            raise ValueError()
